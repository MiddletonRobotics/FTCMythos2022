...
public class Polynomial extends PolynomialFunction {
    ...
    public Polynomial(double[] c, boolean arcLength) throws NullArgumentException, NoDataException {
        super(c);
    ...
    public static double getArcLength(PolynomialSplineFunction function, double maxX) {
        ...
        for(int i = 0; i < polynomials.length; i++) polynomials[i] = new Polynomial(polynomials[i].getCoefficients(), true);
