...
import static MiddletonLibrary.Resources.Utils.VUFORIA_KEY;
...
public class Vuforia {
    ...
    public Vuforia(String t1, String t2, String t3, String asset) {
    ...
    public Vuforia(String t1, String t2, String asset)  {
        parameters.vuforiaLicenseKey = VUFORIA_KEY;
        parameters.cameraDirection = VuforiaLocalizer.CameraDirection.BACK;
        this.vuforia = ClassFactory.getInstance().createVuforia(parameters);
        targetOne = t1;
    ...
    public Vuforia(String t1, String asset) {
        parameters.vuforiaLicenseKey = VUFORIA_KEY;
        parameters.cameraDirection = VuforiaLocalizer.CameraDirection.BACK;
        this.vuforia = ClassFactory.getInstance().createVuforia(parameters);
        targetOne = t1;
