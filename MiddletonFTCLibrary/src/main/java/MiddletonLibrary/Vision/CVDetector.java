...
import static MiddletonLibrary.Resources.Utils.getDash;

/**
 * Created by Keval Kataria on 6/1/2020.
 */

public abstract class CVDetector extends OpenCvPipeline {
    ...
    protected List<MatOfPoint> findContours(CVColorFilter filter, Mat mask) {
